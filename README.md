...
一个用 React + Vite 实现的桌游规则原型，用来测试《余香》这套“选材、排瓶、封瓶、挥发、顾客卡”机制是否能自然形成策略取舍。

当前 React 版本的视觉布局参考了仓库中的 HTML 原型，采用了米白纸面、金色细线、双香瓶中轴和香材卡片式工作台。
...
- `src/styles.css`：主视觉样式

参考资料：

- `docs/design/余香_规则草案_v0.3.md`
