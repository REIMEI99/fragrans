...
export const CUSTOMER_CARDS: CustomerCard[] = [
  { id: "c1", title: "渐进感", text: "最长排列链长度至少为 2。", predicate: { type: "runAtLeast", length: 2 } },
  { id: "c2", title: "长句子", text: "最长排列链长度至少为 3。", predicate: { type: "runAtLeast", length: 3 } },
  { id: "c3", title: "偏爱重复", text: "存在同一香材至少重复 2 次。", predicate: { type: "sameIngredientAtLeast", count: 2 } },
  { id: "c4", title: "强烈执念", text: "存在同一香材至少重复 3 次。", predicate: { type: "sameIngredientAtLeast", count: 3 } },
  { id: "c5", title: "木辛尾调", text: "存在相邻的“木质 -> 辛香”。", predicate: { type: "containsPairAdjacent", pair: ["wood", "spice"] } },
  { id: "c6", title: "花果转折", text: "存在相邻的“花香 -> 果香”。", predicate: { type: "containsPairAdjacent", pair: ["floral", "fruit"] } },
  { id: "c7", title: "柑橘开场", text: "第 1 格是柑橘。", predicate: { type: "startsWith", ingredient: "citrus" } },
  { id: "c8", title: "辛香收尾", text: "最后一格是辛香。", predicate: { type: "endsWith", ingredient: "spice" } },
  {
    id: "c9",
    title: "自然线条",
    text: "同时包含柑橘、花香、木质。",
    predicate: { type: "containsIngredients", ingredients: ["citrus", "floral", "wood"] },
  },
  { id: "c10", title: "繁复成香", text: "香材数至少为 5。", predicate: { type: "bottleSizeAtLeast", count: 5 } },
  { id: "c11", title: "满而不重", text: "6 格全满且没有重复香材。", predicate: { type: "allDistinct" } },
  {
    id: "c12",
    title: "两头张扬",
    text: "同时包含柑橘与辛香。",
    predicate: { type: "containsIngredients", ingredients: ["citrus", "spice"] },
  },
];
